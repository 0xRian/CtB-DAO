...
const Home = () => {
  ...
  async function createProposal(newProposal) {
    let options = {
      contractAddress: "0xEDf3dffeC3c9BB16eB645e4fC64f97405BfD342F",
    ...
    if (isInitialized) {
      ...
      const fetchTokenIdOwners = async () => {
        const options = {
          ...
          token_id:
            "90618450716541302461425165258031486918416419832925981397535856512242414518372",
          chain: "mumbai",
        };
          ...
          <Tab tabKey={1} tabName="DAO">
            {proposals && (
              <div className="tabContent">
                CtB/DAO Developer Governance Overview
